...
func Joyo(text string) int {
	return util.Wc(text, BelongsToJoyo)
}

// JoyoRatio returns percentage of jōyō kanji inside text
// result is between 0 and 1
func JoyoRatio(text string) float64 {
	return float64(Joyo(text)) / float64(utf8.RuneCountInString(text))
}

// BelongsToJoyo returns true if the given rune is a jōyō kanji
func BelongsToJoyo(rune rune) bool {
	return BelongsToShinjitai(rune) || BelongsToKyujitai(rune)
}

// BelongsToShinjitai returns true if the given rune is a Shinjitai kanji
// These are the new, simplified writings of kanji
...
// BelongsToKyujitai returns true if the given rune is a Kyūjitai kanji
// These are the traditional writings of kanji
