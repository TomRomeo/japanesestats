...
// are the 1,026 first kanji characters that Japanese children learn in elementary school,
...
func KyoikuRatio(text string) float64 {
	return float64(Kyoiku(text)) / float64(utf8.RuneCountInString(text))
}

// G1 returns count of kyōiku kanji learned in grade 1 inside text
func G1(text string) int {
	return util.Wc(text, BelongsToG1)
}

// G1Ratio returns percentage of kyōiku kanji learned in grade 1 inside text
// result is between 0 and 1
func G1Ratio(text string) float64 {
	return float64(G1(text)) / float64(utf8.RuneCountInString(text))
}

// G2 returns count of kyōiku kanji learned in grade 2 inside text
func G2(text string) int {
	return util.Wc(text, BelongsToG2)
}

// G2Ratio returns percentage of kyōiku kanji learned in grade 2 inside text
// result is between 0 and 1
func G2Ratio(text string) float64 {
	return float64(G2(text)) / float64(utf8.RuneCountInString(text))
}

// G3 returns count of kyōiku kanji learned in grade 3 inside text
func G3(text string) int {
	return util.Wc(text, BelongsToG3)
}

// G3Ratio returns percentage of kyōiku kanji learned in grade 3 inside text
// result is between 0 and 1
func G3Ratio(text string) float64 {
	return float64(G3(text)) / float64(utf8.RuneCountInString(text))
}

// G4 returns count of kyōiku kanji learned in grade 4 inside text
func G4(text string) int {
	return util.Wc(text, BelongsToG4)
}

// G4Ratio returns percentage of kyōiku kanji learned in grade 4 inside text
// result is between 0 and 1
func G4Ratio(text string) float64 {
	return float64(G4(text)) / float64(utf8.RuneCountInString(text))
}

// G5 returns count of kyōiku kanji learned in grade 5 inside text
func G5(text string) int {
	return util.Wc(text, BelongsToG5)
}

// G5Ratio returns percentage of kyōiku kanji learned in grade 5 inside text
// result is between 0 and 1
func G5Ratio(text string) float64 {
	return float64(G5(text)) / float64(utf8.RuneCountInString(text))
}

// G6 returns count of kyōiku kanji learned in grade 6 inside text
func G6(text string) int {
	return util.Wc(text, BelongsToG6)
}

// G6Ratio returns percentage of kyōiku kanji learned in grade 6 inside text
// result is between 0 and 1
func G6Ratio(text string) float64 {
	return float64(G6(text)) / float64(utf8.RuneCountInString(text))
}

// BelongsToKyoiku returns true if the given rune is part of the kyoiku kanji list
func BelongsToKyoiku(character rune) bool {

	g1 := BelongsToG1(character)
	g2 := BelongsToG2(character)
	g3 := BelongsToG3(character)
	g4 := BelongsToG4(character)
	g5 := BelongsToG5(character)
	g6 := BelongsToG6(character)
	names := BelongsToNames(character)

	return g1 || g2 || g3 || g4 || g5 || g6 || names
}
